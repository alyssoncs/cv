...
\begin{twenty}
	...
	\twentyitem
		...
		{$\bullet$ Became in charge of the design, build and deployment of a flexible service and API for storing log information of other systems using MongoDB;\vskip 4pt
			...
			$\bullet$ Implementation of a mobile application using native Android and firebase that allows visitors to schedule virtual visits to their imprisoned family members,  important resource during the Covid-19 pandemic;\vskip 4pt
